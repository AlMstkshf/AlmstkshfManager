...
const RegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    let result: User | { error: string } | null = null;
    ...
    if (mode === 'join') {
      ...
      result = registerWithInvite(userData, inviteCode, password);
    } else { 
      ...
      result = registerAndCreateOrg(userData, organizationName, password);
    }
    ...
    if (result && 'id' in result) { 
      ...
      setError(t('registrationFailedError'));
    }
  };
