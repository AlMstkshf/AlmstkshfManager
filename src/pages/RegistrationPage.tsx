...
const RegistrationPage: React.FC = () => {
  ...
  const commonInputClass = "bg-whi@/80 focus:bg-whi@/90";
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-60 p-8 rounded-xl shadow-2xl">
       ...
       @/div>
        ...
        <div className="mb-6 flex justify-center border border-gray-300 rounded-lg p-1 bg-gray-1@/70">
          <button
            onClick={() => handleModeChange('create')}
            className={`w@/2 py-2 px-4 rounded-md text-sm font-medium transition-colors duration-150 ease-in-out
