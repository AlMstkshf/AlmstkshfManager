...
import { formatDate, getTaskStatusColor, getTaskPriorityPill } from @/uti@/helpers';
...
const CommentIcon = () => <svg xmlns="htt@//www.w3.o@/20@/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-3.862 8.25-8.625 8.25CF7.862 20.25 4 16.556 4 12c0-4.556 3.862-8.25 8.625-8.25s8.625 3.694 8.625 8.25z@/@/svg>;
const ExclamationCircleIcon = () => <svg xmlns="htt@//www.w3.o@/20@/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-red-500"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z@/@/svg>;

const LockClosedIcon = () => <svg xmlns="htt@//www.w3.o@/20@/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3 h-3 text-gray-500 mr-1"><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z@/@/svg>;
      ...
      <div className="flex justify-between items-start">
       ...
       @/div>
        <div className="flex space-x-1 rtl:space-x-reverse">
           {canEditThisTask && <Button onClick={onEdit} variant="ghost" size="sm" className="p-1.5" aria-label={t('editTaskBtn')} title={t('editTaskBtn')}><EditIco@/@/Button>}
           {canDeleteThisTask && <Button onClick={onDelete} variant="ghost" size="sm" className="p-1.5 text-red-500 hover:bg-red-100" aria-label={t('deleteTaskBtn')} title={t('deleteTaskBtn')}><DeleteIco@/@/Button>}
       @/div>
     @/div>
     ...
     @/div>
      <div className="mt-3 pt-2 border-t border-gray-100 flex justify-end">
        <Button 
            ...
            variant="ghost" 
            size="sm" 
            leftIcon={hasUrgentComments ? <ExclamationCircleIco@/> : <CommentIco@/>}
