...
const SentimentIcon: React.FC<{ sentiment?: TaskCommentSentiment, isUrgent?: boolean }> = ({ sentiment, isUrgent }) => {
  ...
  switch (sentiment) {
    ...
    case TaskCommentSentiment.Neutral:
      iconJsx = <svg xmlns="htt@//www.w3.o@/20@/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 15L12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9@/@/svg>;
  ...
  const UrgentIcon = () => <svg xmlns="htt@//www.w3.o@/20@/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-red-600 ml-1 rtl:ml-0 rtl:mr-1"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z@/@/svg>;
