...
import { Project, Task, TaskStatus, User } from '@/@/types'@// Added User
...
const DashboardAnalytics: React.FC<DashboardAnalyticsProps> = ({ projects, tasks, users }) => {
  ...
  const totalUsersInOrg = users.length@// Assuming `users` prop from context is already organization-scoped
