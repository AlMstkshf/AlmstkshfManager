                ...
                {insight.relatedProjectIds && insight.relatedProjectIds.length > 0 && (
                  <div>
                    ...
                    {insight.relatedProjectIds.map((id, idx) => {
                      ...
                      return project ? (
                        <Link key={id} to=@/proje@/${id}`} className="text-primary hover:underline">
                ...
                {insight.relatedTaskIds && insight.relatedTaskIds.length > 0 && (
                   <div>
                    ...
                    {insight.relatedTaskIds.map((id, idx) => {
                        ...
                        return task ? (
                             <Link key={id} to=@/proje@/${task.projectId}`} className="text-primary hover:underline" title={`${t('viewTaskLink')} in project ${getProjectById(task.projectId)?.name || ''}`}>
